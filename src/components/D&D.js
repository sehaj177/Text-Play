...
export default function About(props) {
    ...
    const dragEnd=(e) => {
        ...
        const dragLeave=(e)=>{
         ...
         const drop=(e)=>{
             e.target.push ='imgBox';    
         }
       
    
    return (
        <>
            <h1 className='hh'>Drag&Drop</h1>
            <div className='aboutBG'>
                <div className="whiteBox">
                    <div className="imgBox" onDrag={dragStart} onDragEnd={dragEnd}  ></div>
                </div>
...
//                         </div>
//                     </div><br />
//                     {/* <button  className='btn btn-secondary' onClick={toggleStyle} id='darkmode'>Enable dark mode</button> */}
//                 </div>
//             </div>
//         </>
//     )
